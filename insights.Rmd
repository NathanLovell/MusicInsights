...
pseudonym/artist_song/rating

```{r}
gathered_ratings <- gather(preferences, key = "artist_song", value = "Rating", 3:45)
Ratings <- tibble(pseudonym=gathered_ratings$'What was your pseudonym?', artist_song=gathered_ratings$artist_song, rating=gathered_ratings$Rating)
